...
def bibliotheque2():
    ...
    biblio.ajouter_livre_dans_liste(Livre("Le Nom de la Rose", "Umberto Eco", "12MO5", "Roman historique"))
    biblio.ajouter_livre_dans_liste(Livre("Le Petit Prince", "Antoine de Saint-Exupéry","AA151", "Conte"))
    biblio.ajouter_livre_dans_liste(Livre("Le Comte de Monte-Cristo", "Alexandre Dumas","PP78H", "Aventure"))
    biblio.ajouter_livre_dans_liste(Livre("Les Corbeau et le Renard", "Jean de La Fontaine","JJ474", "Fable"))
...
@pytest.fixture
def livre1():
    return Livre("1984", "George Orwell", "12345","Roman")
